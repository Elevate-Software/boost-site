        ...
        <div className="py-12 bg-gray-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="lg:text-center">
                    <h2
                        className="btn-style-2 inline-flex items-center justify-center bg-gray-900 text-white text-sm lg:text-base font-medium rounded transition-all duration-500 px-4 py-2 mb-2">ABOUT</h2>
                ...
                <div className="mt-10">
                    <ul role="list" className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 my-6">
                        ...
                        <li
                            className="col-span-1 flex flex-col text-center bg-gray-900 rounded-lg shadow divide-y divide-gray-200"
                        >
